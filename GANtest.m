...
PROGRAM DESCRIPTION
-------------------
This script finds the MSE between the generated costates by the Hamilatonian GAN and the ones calculated by formula
...
mse1 = mse1';
mse2 = mse2';
mse_hgan = [mse1,mse2]; % The MSE errors for the costates
